...
public class StudyMaterialsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        FirebaseRecyclerAdapter<Blog, StudyMaterialsFragment.BlogViewHolder> firebaseRecyclerAdapter= new FirebaseRecyclerAdapter<Blog, StudyMaterialsFragment.BlogViewHolder>(
                Blog.class,
                R.layout.blog_row,
                StudyMaterialsFragment.BlogViewHolder.class,
                mStudyMaterials
        ) {
            @Override
            protected void populateViewHolder(StudyMaterialsFragment.BlogViewHolder viewHolder, Blog model, int position) {
